...
public class FallenPortalOnClickProcedure extends FallenModElements.ModElement {
	public FallenPortalOnClickProcedure(FallenModElements instance) {
		super(instance, 9);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FallenMod.LOGGER.warn("Failed to load dependency entity for procedure FallenPortalOnClick!");
			return;
		}
