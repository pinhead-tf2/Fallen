...
public class FadedGrassBlock extends FallenModElements.ModElement {
	@ObjectHolder("fallen:faded_grass")
	public static final Block block = null;
	public FadedGrassBlock(FallenModElements instance) {
		super(instance, 1);
	}
