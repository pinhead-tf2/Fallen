...
public class FadedOakLogBlock extends FallenModElements.ModElement {
	@ObjectHolder("fallen:faded_oak_log")
	public static final Block block = null;
	public FadedOakLogBlock(FallenModElements instance) {
		super(instance, 6);
	}
